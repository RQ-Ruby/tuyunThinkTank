...
import com.RQ.tuyunthinktank.model.dto.spaceuser.SpaceUserAddRequest;
import com.RQ.tuyunthinktank.model.dto.spaceuser.SpaceUserEditRequest;
import com.RQ.tuyunthinktank.model.dto.spaceuser.SpaceUserQueryRequest;
import com.RQ.tuyunthinktank.model.entity.SpaceUser;
import com.RQ.tuyunthinktank.model.entity.User;
import com.RQ.tuyunthinktank.model.vo.SpaceUserVO;
...
public class SpaceUserController {
    ...
    public BaseResponse<List<SpaceUserVO>> listMyTeamSpace(HttpServletRequest request) {
        ...
        List<SpaceUserVO> voList = spaceUserService.getSpaceUserVOList(spaceUserList);
        // 过滤掉空间已删除的孤立成员记录（防止前端显示无名团队）
        voList = voList.stream()
                .filter(vo -> vo.getSpace() != null && vo.getSpace().getId() != null)
